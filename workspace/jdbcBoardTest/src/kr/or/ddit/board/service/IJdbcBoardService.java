...
public interface IJdbcBoardService {
	/**
	 * JdbcBoardVO 객체에 담겨진 자료를 DB에 insert하는 메소드
	 * 
	...
	/**
	 * 게시글 번호를 인수값으로 받아서 해당 게시글 정보를 삭제하는 메소드
	...
	/**
	 * 인수값으로 받은 JdbcBoardVO객체 자료를 이용하여 update하는 메소드
	...
	/**
	 * 게시글 번호를 인수값으로 받아서 해당 게시글 정보를 가져와 반환하는 메소드
	...
	/**
	 * DB의 게시판 테이블의 전체 테이블을 가져와 List에 담아서 반환하는 메소드
	 * 
	...
	/**
	 * 검색할 게시글 제목을 인수값으로 받아서 검색 결과를 반환하는 메소드
	...
	/**
	 * 게시글 번호를 인수값으로 받아서 해당 게시글의 조회수를 증가하는 메소드
