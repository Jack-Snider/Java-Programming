...
public class JdbcBoardController {
	...
	private IJdbcBoardService service; // 서비스 객체가 저장될 변수
	...
	private void viewBoard() {
		...
		System.out.println(" 메뉴 : 1. 수정    2. 삭제    3. 리스토로 가기");
	...
	private void update(int boardNo) {
		...
		if(cnt > 0) {
			System.out.println(boardNo + "번글이 수정이 되었습니다.");
		}else {
	...
	// 게시판 목록을 보여주고 메뉴를 나타내고, 사용자로부터 작업 번호를 입력받아 반환하는 메소드
