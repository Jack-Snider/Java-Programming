...
public class EqualsHashcodeTest {
	...
	public static void main(String[] args) {
		...
		// 컬렉션 객체들은 객체의 의미상 동일성을 비교하기 위해서 hashCode()
		// 메서드를 호출하여 비교한다.
		...
		HashMap<String, Person> testMap = new HashMap<String, Person>();
		testMap.put("홍길동", p1);
 ...
 * 
 * // 참조값이 같은지 검사 if (this == obj) return true;
 * 
 * // 같은 종류의 class인지 검사 if (this.getClass() != obj.getClass()) return false;
 * 
 * // 매개변수의 값을 현재 객체 유형으로 형변환한다. Person that = (Person) obj;
 * 
 * if (this.name == null && that.name != null) { return false; }
 * 
 * if(this.num == that.num && this.name == that.name) { return true; }
 * 
 * if(this.num==that.num && this.equals(that.name)) { return true; }
 * 
 * return false; } }
 */