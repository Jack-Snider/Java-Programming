 ...
 * 5.열거형이름.value() ==> 모든 상수들을 배열에 담아서 반환한다.
 * 
 * - 열거형 선언하기
 * 방법1)
...
public class EnumTest {
	...
	public static void main(String[] args) {
		/*
		 * // final 상수 사용하기 System.out.println("Red : " + ConstTest.RED);
		 * System.out.println("Three : " + ConstTest.THREE);
		 * 
		 * if(ConstTest.RED == ConstTest.THREE) { System.out.println("ㅋㅋㅋㅋㅋ"); }else{
		...
		/*
		 * 서로 다른 종류의 열거형끼리의 비교는 불가능하다. if(Color.BLUE==Count.TWO) {
		 * 
		 * }
		 */
