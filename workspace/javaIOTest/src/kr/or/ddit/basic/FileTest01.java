...
public class FileTest01 {
	...
	public static void main(String[] args) {
		...
		// File file1 = new File("d:/D_Other/test.txt"); //구분 문자로 '/'를 사용
		...
		// ==> 'parent' 디렉토리 안에 있는 'child' 파일 갖는 File 객체 생성
		...
		// 폴더(디렉토리) 만들기
		/*
		 * -mkdir() ==> File객체의 경로 중 마지막 위치의 디렉토리를 생성한다. 반환값 ==> 만들기 성공(true), 실패(false)
