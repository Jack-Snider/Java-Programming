 ...
 * 이 때 사ㅓ용하던 자원을 정리하지 못하고 프로그램이 종료되어
...
public class ThreadTest11 {
   ...
   public static void main(String[] args) {
      ...
      th1.setStop(true);  // 정상적 자원 정리 후 종료
      //th1.stop(); // 자원 정리가 안되고 종료
      */
      ...
      */
      ...
      while(true) {
         ...
         */
         ...
         //검사방법 2 ==> Thread의 정적메서드인 interrupted() 메서드 이용하기
