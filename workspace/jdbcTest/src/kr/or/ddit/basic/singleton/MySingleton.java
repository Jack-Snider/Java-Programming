...
/*
    ...
    - singleton클래스를 만드는 방법 (필수 구성 요소)
       ...
       2. 생성자의 접근제한자를 private으로 한다. (외부에서 new명령을 사용하지 못하게 하기 위해서...)
          (기본 생성자만 있더라도 반드시 생성자를 작성해야 한다.)
          
       3. 자신class의 인스턴스를 생성하고 반환하는 public static으로 작성한다.
...
public class MySingleton {
   ...
   //2번
   private MySingleton() {
      System.out.println("생성자 입니당 >.ㅇ");
   }
   
   //3번
   public static MySingleton getInstance() {
      //1번에서 선언한 변수가 null이면 객체를 생성해서 저장한다.
