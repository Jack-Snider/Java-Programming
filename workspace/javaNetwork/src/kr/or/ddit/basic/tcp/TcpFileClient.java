...
서버와 클라이언트가 접속이 완료되면 클라이언트가 'd:/HighJava_Practice/펭귄.jpg' 파일을 서버로 전송한다. 

서버는 클라이언트가 보내온 파일을 받아서 'd:/HighJava_Practice/연습용' 폴더에 저장한다. 
...
public class TcpFileClient {
   ...
   public static void main(String[] args) {
      new TcpFileClient().clientsStart();
   }
   
   public void clientsStart() {
      //전송할 파일 정보를 갖는 File 객체 생성
//      File file = new File("d:/HighJava_Practice/펭귄.jpg");
    ...
    // Dialog창을 띄워주고 선택한 파일 정보를 반환하는 메서드
      public File showDialog(String option) {
         ...
         chooser.setCurrentDirectory(new File("d:/HighJava_Practice"));
